...
open class YdbTable(name: String = "") : Table(name) {
    ...
    fun getYdbSecondaryIndices(): List<YdbSecondaryIndexSpec> = ydbSecondaryIndices.toList()
    ...
    override fun createStatement(): List<String> {
        ...
        val indexesSql = ydbSecondaryIndices.joinToString(", ") { renderYdbSecondaryIndex(it) }
