...
class OptimisticLockingIT : BaseYdbTest() {
    ...
    @Test
    fun `should reject stale update after version was changed`() = tx {
        Documents.insert {
            it[id] = 1
            it[title] = "draft"
            it[version] = 0
        ...
        val firstUpdate = YdbOptimisticLocking.updateWithVersion(
            table = Documents,
            idColumn = Documents.id,
            idValue = 1,
            versionColumn = Documents.version,
        ...
        val staleUpdate = YdbOptimisticLocking.updateWithVersion(
            table = Documents,
            idColumn = Documents.id,
            idValue = 1,
            versionColumn = Documents.version,
            ...
            it[Documents.title] = "overwritten"
        }
