...
/**
 * An <code>UPSERT</code> statement (model API).
 * <p>
 * This type is the model API representation of a {@link Upsert} statement,
 ...
 * <p>
 * Instances can be created using {@link YdbDSLContext#upsertQuery(Table)} and
 * overloads.
 *
 * @param <R> The record type of the table being upserted into
 */
public interface UpsertQuery<R extends Record> extends StoreQuery<R>, Upsert<R> {

    /**
     * Adds a new Record to the upsert statement for multi-record upserts
     * <p>
